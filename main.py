...
@app.route('/business_unit_cost_and_revenue_visualisation_and_revenue_alignment')
def business_unit_cost_and_revenue_visualisation_and_revenue_alignment(name=None):
    ...
    return render_template('business_unit_cost_and_revenue_visualisation_and_revenue_alignment.html', array = array)
...
def get_one_cost_and_revenue_unit(name=None):
    ...
    return render_template('business_unit_cost_and_revenue_visualisation_and_revenue_alignment.html', array = array, labels=labels, cost_result=cost_result, revenue_result=revenue_result, result=result, revenue_alignment=revenue_alignment)
